            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        <p style="font-size: 20px"> Hi {{ $authorOfPost->first_name }},</p>
                        <p>{{ $authorOfComment->first_name . " " . $authorOfComment->last_name }} wrote a comment on your post - {{ $post->title }}</p>

                    </td>
                </tr>
                <tr>
                    <td valign="top" bgcolor="#14A5E0" style="padding: 20px " class="center" align="center">
                        <a href="{{url('/posts/' . $post->id . "/view")}}" style="color: #14a5e0">View comment</a>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
