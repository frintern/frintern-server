...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="100%" valign="top" bgcolor="#ffffff" style="padding-top:20px">
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%">
                        <p style="font-size: 20px"> Hi there!</p>
                        {{--<p style="font-size: 20px"> Hi {{$user->first_name}},</p>--}}
                        Jide Owosakin to <span style="color: #14a5e0">Meetrabbi </span>and thanks for joining us.
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding: 20px " class="center">
                        <p>We are about to launch something great, while we are warming up, You can however in the meantime share the love by referring your friends using the link below: </p>
                        {{--<a href="{{url('refer')."?code=" . $user->referral_code}}" style="color: #14a5e0">{{url('refer?code=' . $user->referral_code)}}</a>--}}

                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding: 20px " class="center">
                        If you cannot click on this link, please copy and paste it to your browser.
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
                        ...
                        <table  border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td  class="center" style="font-size: 12px; color: #ffffff; font-weight: bold; text-align: center; font-family: Lato, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                    ...
                                    please send an email to <a style="color: black" href="mailto:hello@meetrabbi.com">hello@meetrabbi.com </a>
                                </td>
                            </tr>
                        </table>
                    </td>
