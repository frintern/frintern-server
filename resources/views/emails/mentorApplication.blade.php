            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%">
                        <p style="font-size: 20px"> Dear {{ $applicant->name }},</p>
                        Thank you for expressing your interest in mentoring on <span style="color: #14a5e0">MeetRabbi </span>.
                        <p>We are currently reviewing you application. You will be contacted shortly.</p>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
