            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        ...
                        It looks like we've received a password reset request for the <strong>MeetRabbi</strong> account tied to this email. </br>
                        <p>To reset your password, just click the link below. </p>
                        
                        <p>If you did not make this request, you are free to ignore this email.</p> 
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding: 20px " class="center">
                        <a href="{{url('/#/password/reset')."/".$token}}" style="color: #14a5e0">Confirm Password Reset</a>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
