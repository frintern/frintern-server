            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        <p style="font-size: 20px"> Dear {{$mentor->name}},</p>
                        You have received an invitation from {{$creator->name}} to participate as a <strong>mentor</strong> in the mentorship program<span style="color: #14a5e0"> {{$program->title}} </span>.
                    </td>
                </tr>

                <tr>
                    <td valign="top" style="padding: 7px 15px; text-align: center; background-color: #14a5e0;" class="center">
                        <a style="color: #fff; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif; text-alight: center;" href="{{ url('/programs/'. $program->id .'/home') }}">Accept Invitation</a>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
                        ...
                        <table  border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td  class="center" style="font-size: 12px; color: #ffffff; font-weight: bold; text-align: center; font-family: Lato, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                    ...
                                    please send an email to <a href="mailto:hello@meetrabbi.com">hello@meetrabbi.com</a>                                 </td>
