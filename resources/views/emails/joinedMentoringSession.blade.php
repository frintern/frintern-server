            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%">
                        <p style="font-size: 20px"> Hi {{ $session->creator->name }}</p>
                        {{ $participant->name }}<span style="color: #14a5e0"> joined your session -  {{ $session->topic }}</span>.
                        <p>
                            Click <a href="https://www.meetrabbi.com/#/mentoring-session/{{$session->id}}/posts">here</a> to <a href="">view session</a>.
                        </p>
