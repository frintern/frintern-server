                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                                        <tr>
                                            <td class="center" style="padding: 10px 0px 10px 0px">
                                                <a href="http://meetrabbi.com"><img src="{{url('assets/img/meetrabbi.png')}}" style="width: 180px"></a>
                                            </td>
                                        </tr>
                                    </table><!--End logo-->
                                </td>
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        {{--<p style="font-size: 20px"> Hi Babajide,</p>--}}
                        <p style="font-size: 20px"> Hi {{$data['user']->first_name}},</p>
                        You have a new follower on Meetrabbi.
                    </td>
                </tr>
                <tr>
                    <td align="center" class="center" style="padding: 10px 0px 10px 0px">

                        @if($data['followed_by']->avatar_uri !== "")
                            <a href="#"><img src="{{url($data['followed_by']->avatar_uri)}}" style="width: 180px; max-width: 100px; margin-top: -70px; margin-bottom: 5px; border: 3px solid #fff; border-radius: 100%; box-shadow: 0 1px 1px rgba(0,0,0,0.1)"></a><br>
                        @else
                            <a href="#"><img src="{{url('assets/img/avatar.png')}}" style="width: 180px; max-width: 100px; margin-top: -70px; margin-bottom: 5px; border: 3px solid #fff; border-radius: 100%; box-shadow: 0 1px 1px rgba(0,0,0,0.1)"></a><br>
                        @endif
                            <strong>{{$data['followed_by']->first_name . " " . $data['followed_by']->last_name}}</strong>
                        <br>
                        <span>{{$data['followed_by']->headline}}</span><br>
                        <a href="{{"http://meetrabbi.com/#/user/". $data['followed_by']->id . "/profile" }}">View Profile</a>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
                        ...
                        <table  border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td  class="center" style="font-size: 12px; color: #ffffff; font-weight: bold; text-align: center; font-family: Lato, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                    ...
                                    please send an email to hello@meetrabbi.com                                </td>
                            </tr>
                        </table>
                    </td>
                </tr>
