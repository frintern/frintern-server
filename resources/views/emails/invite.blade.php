                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                                        <tr>
                                            <td class="center" style="padding: 10px 0px 10px 0px">
                                                <a href="{{url('/')}}"><img src="{{url('assets/img/meetrabbi.png')}}" style="width: 180px"></a>
                                            </td>
                                        </tr>
                                    </table><!--End logo-->
                                </td>
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        ...
                        Your friend {{$sender}}, has invited you to join <span style="color: #14a5e0">Meetrabbi </span>.
                    </td>
                </tr>

                <tr>
                    <td valign="top" style="padding: 20px " class="center" width="100%" bgcolor="#f7f7f7">
                        <span style="color: #14a5e0">MeetRabbi </span> is an online mentoring platform. We are committed to making learning experiential for you by helping you stand on the shoulder of giants.<br>

                <tr>
                    <td valign="top" style="padding: 7px 15px; text-align: center; background-color: #fff;" class="center">

                        <p style="font-size: 20px"> It's time to leverage on those that have gone ahead!</p>
                    </td>

                </tr>
                    <tr>
                        <td valign="top" style="padding: 7px 15px; text-align: center; background-color: #14a5e0;" class="center">

                            <a style="color: #fff; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif; text-alight: center;" href="//www.meetrabbi.com/#/register">JOIN NOW</a>
                        </td>
                    </tr>
                </td>
                </tr>
